	...
	resource "azurerm_storage_share" "aci-share" {
	  ...
	  resource_group_name  = "${var.resource_group_name}"
	  storage_account_name = "${var.resource_storage_acct}"
	...
	resource "azurerm_container_group" "aci-helloworld" {
	  ...
	  container {
	    ...
	    volume {
	      ...
	      storage_account_name  = "${var.resource_storage_acct.aci-sa.name}"
	      storage_account_key   = "${var.resource_storage_acct.aci-sa.primary_access_key}"
	    }
	  }
